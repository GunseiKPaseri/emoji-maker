          ...
          {config.useGradient ? (
            <div className="space-y-4">
              ...
              <div>
                ...
                <Listbox value={config.gradientDirection} onChange={direction => handleChange('gradientDirection', direction)}>
                  {({ open }) => (
                    <>
                      <div className="relative">
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  <button
                    key={index}
                    onClick={() => {
                      console.log('Preset clicked:', preset.colors[0], preset.colors[1])
                      // 両方の色を同時に設定するため、1つのhandleChangeで更新
                      onConfigChange({
                        ...config,
